...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:00f7ff,100:7928ca&height=200&section=header&text=Ghulam%20Mujtaba&fontSize=52&fontColor=ffffff&fontAlignY=38&desc=AI%20%26%20ML%20Engineer%20%E2%80%94%20Autonomous%20Driving&descAlignY=60&descSize=18&animation=fadeIn" width="100%"/>
...
| Domain | Skills |
|--------|--------|
| 👁️ **Computer Vision** | Object Detection · Segmentation · Depth Estimation · 3D Scene Understanding |
| 📡 **Sensor Fusion** | Camera · LiDAR · Radar · Kalman Filters · Multi-modal Fusion |
| 🧬 **Deep Learning** | CNNs · Transformers · ViT · BEV Perception · Temporal Modeling |
| 🔁 **MLOps** | Pipeline Automation · Model Versioning · Docker · CI/CD · Cloud Deployment |
...
> *"The best way to predict the future is to build it — one autonomous mile at a time."*
