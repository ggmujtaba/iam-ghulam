...
<p>
  ...
  <a href="https://x.com/iam_ghulamm"><img src="https://img.shields.io/badge/X-black.svg?style=for-the-badge&logo=X&logoColor=white"/></a>
...
<img src="https://skillicons.dev/icons?i=python,pytorch,tensorflow,opencv,,docker,git,linux"/>
...
├──────────────────────────────────────────────────────┤
│  👁️  PERCEPTION    │  Object Detection · Lane Det.   │
│  📡 FUSION        │  Camera + LiDAR Fusion           │
│  🧠 MODELS        │  CNNs · Transformers · YOLOv8    │
│  🗺️  LOCALIZATION  │  Mapping Basics · Visual Odom.  │
│  ⚙️  SYSTEMS       │  ROS2 · Real-Time Processing    │
│  🚀 DEPLOYMENT    │  Docker · AWS · ONNX             │
└──────────────────────────────────────────────────────┘
```
...
- 🔀 First steps into **Camera + LiDAR Sensor Fusion**
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>🔹 Autonomous Driving Perception System</h3>
      <ul>
        <li>Object Detection + Lane Detection Pipeline</li>
        <li>Built with PyTorch + OpenCV</li>
        <li>Real-time processing with ROS2</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>🔹 Sensor Fusion Project</h3>
      <ul>
        <li>Camera + LiDAR fusion pipeline</li>
        <li>3D object understanding</li>
        <li>Depth estimation from monocular camera</li>
      </ul>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3>🔹 End-to-End Deep Learning Model</h3>
      <ul>
        <li>Input: raw sensor data</li>
        <li>Output: driving decisions</li>
    ...
    <td width="50%" valign="top">
      ...
      <ul>
        <li>🎯 Advanced Sensor Fusion & 3D Perception</li>
        <li>📚 Production-level ML systems</li>
